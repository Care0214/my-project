...
/* ========================================
   ...
   ======================================== */
const users = [
	{ id: 'u1', nickname: '小林同学', avatar: '', avatarBg: '#77C9F1', online: true,
...
const items = [
	...
	{ id: 'i2', title: '华为蓝牙耳机 FreeBuds 4i', description: '去年买的，电池续航正常，轻微使用痕迹，送一个保护套',
		...
		images: ['/static/goods/earbuds.jpg'], imageBg: '#EEF4FF', viewCount: 567, favoriteCount: 42, isHot: true, isNew: false,
	...
	{ id: 'i7', title: '卡西欧计算器 fx-991CN X', description: '考试可用，功能完好，附说明书和原装保护盖',
		...
		images: ['/static/goods/calculator.jpg'], imageBg: '#EEF4FF', viewCount: 178, favoriteCount: 22, isHot: false, isNew: false,
	...
	{ id: 'i10', title: '索尼WH-1000XM4降噪耳机', description: '头戴式降噪耳机，考研自习室神器，续航30小时',
		...
		images: ['/static/goods/headphones.jpg'], imageBg: '#EEF4FF', viewCount: 1024, favoriteCount: 89, isHot: true, isNew: false,
		seller: users[4], publishTime: new Date(Date.now() - 10800000).toISOString(), publishTimeText: '3小时前' },
	{ id: 'i11', title: '宿舍用小冰箱 迷你冷藏', description: '4L容量，适合夏天冷藏饮料和水果，宿舍功率友好',
		type: 'sell', price: 85, categoryId: 'c3', category: 'daily', campus: '千佛山校区', location: '千佛山校区',
		images: ['/static/goods/fridge.jpg'], imageBg: '#FFF5EE', viewCount: 132, favoriteCount: 9, isHot: false, isNew: true,
		seller: users[3], publishTime: new Date(Date.now() - 86400000).toISOString(), publishTimeText: '1天前' },
	{ id: 'i12', title: '折叠床 午休神器 加厚海绵', description: '办公室/宿舍午休用，可折叠不占地方，舒适透气',
		type: 'sell', price: 120, categoryId: 'c3', category: 'daily', campus: '长清湖校区', location: '长清湖校区',
		images: ['/static/goods/bed.jpg'], imageBg: '#FFF5EE', viewCount: 143, favoriteCount: 13, isHot: false, isNew: false,
		seller: users[4], publishTime: new Date(Date.now() - 172800000).toISOString(), publishTimeText: '2天前' },
	{ id: 'i13', title: '卡西欧fx-82ES PLUS 科学计算器', description: '基础款科学计算器，功能正常，考研可用',
		type: 'sell', price: 25, categoryId: 'c2', category: 'digital', campus: '千佛山校区', location: '千佛山校区',
		images: ['/static/goods/calculator.jpg'], imageBg: '#EEF4FF', viewCount: 76, favoriteCount: 5, isHot: false, isNew: false,
		seller: users[3], publishTime: new Date(Date.now() - 86400000).toISOString(), publishTimeText: '1天前' },
];
...
const exchangePosts = [
	{ id: 'e1', title: '求购二手考研数学资料（数一）', description: '有没有上岸的学长学姐出考研数学一的资料呀~',
		...
		replyCount: 3, favoriteCount: 6, reward: null, images: [], imageBg: '#FFF5EE',
		replies: [
			{ id: 'er11', user: users[1], content: '我去年上岸，有一套数一资料，可以聊聊~', time: '10分钟前' },
			{ id: 'er12', user: users[3], content: '同求，蹲一个', time: '8分钟前' },
			{ id: 'er13', user: users[0], content: '有的同学可以私信我哦', time: '5分钟前' },
		] },
	{ id: 'e2', title: 'Kindle Paperwhite 4 换一个计算器', description: '吃灰kindle换一个卡西欧计算器，考试用，要求功能正常',
		...
		replyCount: 5, favoriteCount: 12, images: [], imageBg: '#EEF4FF',
		replies: [
			{ id: 'er21', user: users[2], content: '我有个卡西欧 fx-991CN，换吗？', time: '30分钟前' },
			{ id: 'er22', user: users[0], content: 'kindle成色怎么样？', time: '25分钟前' },
			{ id: 'er23', user: users[1], content: '九成新，无划痕，带保护套', time: '20分钟前' },
			{ id: 'er24', user: users[2], content: '那可以，私聊看下细节图', time: '12分钟前' },
			{ id: 'er25', user: users[4], content: '来晚了，排个队', time: '5分钟前' },
		] },
	{ id: 'e3', title: '帮忙去南门取个快递', description: '今天下午有快递到南门菜鸟驿站，有没有顺路的同学帮忙取一下，10元感谢费',
		...
		replyCount: 2, favoriteCount: 3, reward: 10, images: [], imageBg: '#F0FFF0',
		replies: [
			{ id: 'er31', user: users[1], content: '我下午顺路，可以帮你取', time: '6分钟前' },
			{ id: 'er32', user: users[2], content: '太好了，私信你取件码', time: '3分钟前' },
		] },
	{ id: 'e4', title: '拼单买纸巾，一箱太多用不完', description: '趁活动买了一箱24包抽纸，太多了，有没有同学一起拼，一箱50，对半分也行',
		...
		replyCount: 7, favoriteCount: 5, reward: null, images: [], imageBg: '#FFF8F0',
		replies: [
			{ id: 'er41', user: users[0], content: '我想拼，对半怎么算？', time: '2小时前' },
			{ id: 'er42', user: users[4], content: '带我一个，微信聊', time: '1小时前' },
			{ id: 'er43', user: users[3], content: '人够了，先私信确认下数量', time: '40分钟前' },
		] },
	{ id: 'e5', title: '代跑一次体测800米', description: '女生，帮忙代跑，价格私聊',
		...
		replyCount: 4, favoriteCount: 2, reward: 30, images: [], imageBg: '#FFF0F0',
		replies: [
			{ id: 'er51', user: users[2], content: '代跑有风险，注意安全呀', time: '8小时前' },
			{ id: 'er52', user: users[4], content: '谢谢提醒，会注意的', time: '7小时前' },
		] },
	{ id: 'e6', title: '求借一辆自行车用一周', description: '考试周需要用，长清湖校区范围内，会好好保管，可付押金',
		...
		replyCount: 2, favoriteCount: 4, reward: 15, images: [], imageBg: '#EEF4FF',
		replies: [
			{ id: 'er61', user: users[0], content: '我有一辆可以借，押金随意', time: '1小时前' },
			{ id: 'er62', user: users[3], content: '太好了，私聊', time: '50分钟前' },
		] },
];
...
const conversations = [
	{ id: 'conv1', user: users[0], lastMessage: '你好，这个耳机还在吗？', lastMessageTime: '2分钟前',
		...
		messages: [
			{ id: 'm1', from: 'other', text: '你好，这个耳机还在吗？', time: new Date(Date.now() - 180000).toISOString() },
			{ id: 'm2', from: 'me', text: '在的，你要看一下吗', time: new Date(Date.now() - 120000).toISOString() },
			{ id: 'm3', from: 'other', text: '好的，下午方便面交吗？', time: new Date(Date.now() - 60000).toISOString() },
		] },
	{ id: 'conv2', user: users[2], lastMessage: '好的，我明天给你送过去', lastMessageTime: '1小时前',
		unreadCount: 0,
		messages: [
			{ id: 'm4', from: 'other', text: '台灯还在吗？', time: new Date(Date.now() - 3600000).toISOString() },
			{ id: 'm5', from: 'me', text: '在的', time: new Date(Date.now() - 3540000).toISOString() },
			{ id: 'm6', from: 'other', text: '好的，我明天给你送过去', time: new Date(Date.now() - 3480000).toISOString() },
		] },
	{ id: 'conv3', user: users[4], lastMessage: '吉他最低多少出？', lastMessageTime: '昨天',
		unreadCount: 1, relatedItem: items[3],
		messages: [
			{ id: 'm7', from: 'other', text: '吉他最低多少出？', time: new Date(Date.now() - 90000000).toISOString() },
			{ id: 'm8', from: 'me', text: '450已经是底价了', time: new Date(Date.now() - 89900000).toISOString() },
		] },
	{ id: 'conv4', user: { id: 'u99', nickname: '系统通知', avatarBg: '#77C9F1', online: false },
		lastMessage: '你的商品「台灯 LED 护眼灯」审核通过啦', lastMessageTime: '2天前',
		unreadCount: 0,
		messages: [
			{ id: 'm9', from: 'other', text: '你的商品「台灯 LED 护眼灯」审核通过啦', time: new Date(Date.now() - 172800000).toISOString() },
		] },
];
...
const recommendations = [
	{ id: 'r1', itemId: 'i6', title: '高等数学第七版 上下册 全新', desc: '考研数学必备教材，九成新，上册轻微笔记',
	...
	{ id: 'r2', itemId: 'i10', title: '索尼WH-1000XM4降噪耳机', desc: '头戴式降噪耳机，考研自习室神器，续航30小时',
	...
	{ id: 'r3', itemId: 'i3', title: '桌面LED台灯 三档调光 USB充电', desc: '考研党必备护眼台灯，三档调光，无频闪',
	...
	{ id: 'r4', itemId: 'i7', title: '卡西欧计算器 fx-991CN X', desc: '考试可用，功能完好，附说明书和原装保护盖',
	...
	{ id: 'r5', itemId: 'i11', title: '宿舍用小冰箱 迷你冷藏', desc: '4L容量，适合夏天冷藏饮料和水果，宿舍功率友好',
	...
	{ id: 'r6', itemId: 'i12', title: '折叠床 午休神器 加厚海绵', desc: '办公室/宿舍午休用，可折叠不占地方，舒适透气',
...
const matches = [
	...
	{ id: 'm602', type: 'wish-to-item', title: '你的求购心愿「计算器」可能匹配到这些物品',
		matches: [
			{ id: 'm6021', itemId: 'i7', title: '卡西欧计算器 fx-991CN X', price: 55, user: users[1], campus: '长清湖校区',
				desc: '考试可用，功能完好，附说明书和原装保护盖', publishTime: Date.now() - 43200000 },
			{ id: 'm6022', itemId: 'i13', title: '卡西欧fx-82ES PLUS 科学计算器', price: 25, user: users[3], campus: '千佛山校区',
