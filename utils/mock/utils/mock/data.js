...
/* ========================================
   ...
   ======================================== */
const schools = [
	{ id: 's1', name: 'XX大学', campuses: ['主校区', '东校区', '西校区', '南校区', '北校区'] },
];

const campuses = [
	{ id: 1, name: '主校区' }, { id: 2, name: '东校区' },
	{ id: 3, name: '西校区' }, { id: 4, name: '南校区' }, { id: 5, name: '北校区' },
];
...
const items = [
	{ id: 'i1', title: '全新《算法导论》第三版 考研必备', description: '考研结束便宜出，9成新，几乎没写过字，附赠电子笔记资料~',
		type: 'sell', price: 35, categoryId: 'c1', category: 'book', campus: '主校区', location: '主校区',
		images: [], imageBg: '#EEF4FF', viewCount: 328, favoriteCount: 25, isHot: true, isNew: true,
	...
	{ id: 'i2', title: '华为蓝牙耳机 FreeBuds 4i', description: '去年买的，电池续航正常，轻微使用痕迹，送一个保护套',
		type: 'sell', price: 99, categoryId: 'c2', category: 'digital', campus: '东校区', location: '东校区',
		images: [], imageBg: '#F5F0FF', viewCount: 567, favoriteCount: 42, isHot: true, isNew: false,
	...
	{ id: 'i3', title: '台灯 LED 护眼灯 可调节亮度', description: '宿舍用不到了，三档调光，USB充电，造型好看',
		type: 'sell', price: 18, categoryId: 'c3', category: 'daily', campus: '主校区', location: '主校区',
		images: [], imageBg: '#FFF5EE', viewCount: 189, favoriteCount: 15, isHot: false, isNew: true,
	...
	{ id: 'i4', title: '吉他 Yamaha F310 入门民谣吉他', description: '大二买的，没弹几次就闲置了，保养得还不错，音色很好',
		type: 'sell', price: 450, categoryId: 'c4', category: 'sports', campus: '西校区', location: '西校区',
		images: [], imageBg: '#F0FFF0', viewCount: 892, favoriteCount: 67, isHot: true, isNew: false,
	...
	{ id: 'i5', title: '冬季羽绒服 男款中长款（L码）', description: 'ZARA黑色，就穿过一个冬天，几乎全新',
		type: 'sell', price: 120, categoryId: 'c5', category: 'fashion', campus: '北校区', location: '北校区',
		images: [], imageBg: '#FFF8F0', viewCount: 234, favoriteCount: 18, isHot: false, isNew: false,
	...
	{ id: 'i6', title: '高等数学第七版 上下册 全新', description: '考研数学必备教材，上册轻微笔记，下册全新',
		type: 'sell', price: 28, categoryId: 'c1', category: 'book', campus: '主校区', location: '主校区',
		images: [], imageBg: '#EEF4FF', viewCount: 456, favoriteCount: 34, isHot: false, isNew: false,
	...
	{ id: 'i7', title: '卡西欧计算器 fx-991CN X', description: '考试可用，功能完好，附说明书和原装保护盖',
		type: 'sell', price: 55, categoryId: 'c2', category: 'digital', campus: '东校区', location: '东校区',
		images: [], imageBg: '#F5F0FF', viewCount: 178, favoriteCount: 22, isHot: false, isNew: false,
	...
	{ id: 'i8', title: 'Kindle Paperwhite 4 电子书阅读器', description: '自用一年，屏幕完美，电池一周一充，送保护壳',
		type: 'sell', price: 380, categoryId: 'c2', category: 'digital', campus: '主校区', location: '主校区',
		images: [], imageBg: '#FAFAFA', viewCount: 621, favoriteCount: 53, isHot: true, isNew: false,
	...
	{ id: 'i9', title: '桌面收纳盒套装 3个装', description: '全新未拆封，透明磨砂材质，适合桌面/衣柜收纳',
		type: 'sell', price: 15, categoryId: 'c3', category: 'daily', campus: '西校区', location: '西校区',
		images: [], imageBg: '#FFF5EE', viewCount: 98, favoriteCount: 7, isHot: false, isNew: true,
	...
	{ id: 'i10', title: '索尼WH-1000XM4降噪耳机', description: '头戴式降噪耳机，考研自习室神器，续航30小时',
		type: 'sell', price: 680, categoryId: 'c2', category: 'digital', campus: '南校区', location: '南校区',
		images: [], imageBg: '#F5F0FF', viewCount: 1024, favoriteCount: 89, isHot: true, isNew: false,
...
const leaseItems = [
	{ id: 'l1', title: '单反相机 Canon 700D 套机', desc: '入门单反，配18-55镜头，适合摄影课或出游拍照使用',
		price: 30, deposit: 500, category: 'digital', campus: '主校区',
		images: [], user: users[2], publishTime: Date.now() - 3600000 },
	{ id: 'l2', title: '折叠自行车 26寸', desc: '平时不怎么骑，可以按天出租，车况良好，刹车灵敏',
		price: 8, deposit: 200, category: 'sports', campus: '东校区',
		images: [], user: users[3], publishTime: Date.now() - 18000000 },
	{ id: 'l3', title: '宿舍小冰箱 迷你冷藏箱', desc: '小龙门冰箱，适合夏天放饮料和水果，功率小宿舍能用',
		price: 5, deposit: 150, category: 'daily', campus: '主校区',
		images: [], user: users[0], publishTime: Date.now() - 172800000 },
	{ id: 'l4', title: 'Switch 游戏机 续航版+三款游戏', desc: '续航版红蓝手柄，附塞尔达+动森+马车8三款游戏卡带',
		price: 20, deposit: 600, category: 'digital', campus: '主校区',
		images: [], user: users[4], publishTime: Date.now() - 21600000 },
	{ id: 'l5', title: '露营帐篷 双人双层防雨', desc: '户外社团用的帐篷，双层防雨，含地钉和收纳袋',
		price: 25, deposit: 300, category: 'sports', campus: '东校区',
		images: [], user: users[1], publishTime: Date.now() - 43200000 },
	{ id: 'l6', title: '拍立得相机 富士Instax Mini11', desc: '粉色款，成色很新，适合毕业季拍照留念，附送5张相纸',
		price: 15, deposit: 200, category: 'digital', campus: '西校区',
		images: [], user: users[3], publishTime: Date.now() - 86400000 },
];
...
const exchangePosts = [
	{ id: 'e1', title: '求购二手考研数学资料（数一）', description: '有没有上岸的学长学姐出考研数学一的资料呀~',
		type: 'wish', tab: '求购心愿', isBorrow: false, campus: '主校区', views: 234,
	...
	{ id: 'e2', title: 'Kindle Paperwhite 4 换一个计算器', description: '吃灰kindle换一个卡西欧计算器，考试用，要求功能正常',
		type: 'exchange', tab: '以物换物', campus: '主校区', views: 456,
	...
	{ id: 'e3', title: '帮忙去南门取个快递', description: '今天下午有快递到南门菜鸟驿站，有没有顺路的同学帮忙取一下，10元感谢费',
		type: 'wish', tab: '求助帮忙', isBorrow: false, campus: '南校区', views: 178,
	...
	{ id: 'e4', title: '拼单买纸巾，一箱太多用不完', description: '趁活动买了一箱24包抽纸，太多了，有没有同学一起拼，一箱50，对半分也行',
		type: 'wish', tab: '拼单', campus: '东校区', views: 312,
	...
	{ id: 'e5', title: '代跑一次体测800米', description: '女生，帮忙代跑，价格私聊',
		type: 'wish', tab: '求助帮忙', isBorrow: false, campus: '西校区', views: 189,
	...
	{ id: 'e6', title: '求借一辆自行车用一周', description: '考试周需要用，主校区范围内，会好好保管，可付押金',
		type: 'wish', tab: '求购心愿', isBorrow: true, campus: '主校区', views: 145,
...
const recommendations = [
	{ id: 'r1', title: '高等数学第七版 上下册 全新', desc: '考研数学必备教材，九成新，上册轻微笔记',
		price: 28, type: 'sell', category: 'book', campus: '主校区',
		user: users[0], publishTime: Date.now() - 1800000,
		matchReason: '浏览过考研资料', tag: 'hot' },
	{ id: 'r2', title: '索尼WH-1000XM4降噪耳机', desc: '头戴式降噪耳机，考研自习室神器，续航30小时',
		price: 680, type: 'sell', category: 'digital', campus: '主校区',
		user: users[3], publishTime: Date.now() - 10800000,
		matchReason: '浏览过蓝牙耳机', tag: 'hot' },
	{ id: 'r3', title: '桌面LED台灯 三档调光 USB充电', desc: '考研党必备护眼台灯，三档调光，无频闪',
		price: 22, type: 'sell', category: 'daily', campus: '东校区',
		user: users[2], publishTime: Date.now() - 21600000,
		matchReason: '浏览过台灯', tag: 'good' },
	{ id: 'r4', title: '卡西欧计算器 fx-991CN X', desc: '考试可用，功能完好，附说明书和原装保护盖',
		price: 55, type: 'sell', category: 'digital', campus: '主校区',
		user: users[1], publishTime: Date.now() - 43200000,
		matchReason: '收藏过数码产品', tag: 'match' },
	{ id: 'r5', title: '宿舍用小冰箱 迷你冷藏', desc: '4L容量，适合夏天冷藏饮料和水果，宿舍功率友好',
		price: 85, type: 'sell', category: 'daily', campus: '西校区',
		user: users[3], publishTime: Date.now() - 86400000,
		matchReason: '你可能喜欢的校园好物', tag: 'new' },
	{ id: 'r6', title: '折叠床 午休神器 加厚海绵', desc: '办公室/宿舍午休用，可折叠不占地方，舒适透气',
		price: 120, type: 'sell', category: 'daily', campus: '南校区',
		user: users[4], publishTime: Date.now() - 172800000,
...
const matches = [
	{ id: 'm601', type: 'item-to-wish', title: '你的闲置《算法导论》可能匹配到这些需求',
		matches: [
			{ id: 'm6011', title: '求购算法导论或数据结构教材', user: users[0], campus: '主校区',
				desc: '正在准备考研复试，急需算法相关教材', price: null, publishTime: Date.now() - 7200000 },
			{ id: 'm6012', title: '收计算机专业考研书籍', user: users[1], campus: '东校区',
				desc: '想收408全套，单本也行，价格好商量', price: null, publishTime: Date.now() - 28800000 },
		] },
	{ id: 'm602', type: 'wish-to-item', title: '你的求购心愿「计算器」可能匹配到这些物品',
		matches: [
			{ id: 'm6021', title: '卡西欧计算器 fx-991CN X', price: 55, user: users[1], campus: '主校区',
				desc: '考试可用，功能完好，附说明书和原装保护盖', publishTime: Date.now() - 43200000 },
			{ id: 'm6022', title: '卡西欧fx-82ES PLUS 科学计算器', price: 25, user: users[3], campus: '西校区',
...
const myPublish = [
	{ id: 'mp1', title: items[5].title, desc: items[5].description, type: 'sell', price: 28,
		category: 'book', campus: '主校区', status: 'active', publishTime: Date.now() - 259200000, viewCount: 456, favCount: 34 },
	{ id: 'mp2', title: items[0].title, desc: items[0].description, type: 'sell', price: 35,
		category: 'book', campus: '主校区', status: 'active', publishTime: Date.now() - 300000, viewCount: 328, favCount: 25 },
	{ id: 'mp3', title: '闲置收纳盒套装 3个装', desc: '全新未拆封，透明磨砂材质', type: 'sell', price: 15,
		category: 'daily', campus: '主校区', status: 'sold', publishTime: Date.now() - 1209600000, viewCount: 89, favCount: 6 },
	{ id: 'mp4', title: '滑板 专业板 轻微使用痕迹', desc: '入门时买的，现在换了新板所以出掉', type: 'sell', price: 80,
		category: 'sports', campus: '东校区', status: 'active', publishTime: Date.now() - 172800000, viewCount: 67, favCount: 9 },
];
...
const myExchange = [
	{ id: 'me1', title: exchangePosts[2].title, desc: exchangePosts[2].description, tab: '求助帮忙', type: 'help',
		role: 'publish', status: 'done', reward: 10, campus: '南校区', publishTime: Date.now() - 172800000, replyCount: 3 },
	{ id: 'me2', title: exchangePosts[3].title, desc: exchangePosts[3].description, tab: '拼单', type: 'group',
		role: 'join', status: 'done', reward: null, campus: '东校区', publishTime: Date.now() - 432000000, replyCount: 7 },
	{ id: 'me3', title: '求购二手考研数学资料（数一）', desc: '有没有上岸的学长学姐出考研数学一的资料呀~', tab: '求购心愿',
		type: 'wish', role: 'publish', status: 'active', reward: null, campus: '主校区', publishTime: Date.now() - 43200000, replyCount: 5 },
];

const myLease = [
	{ id: 'ml1', title: leaseItems[0].title, desc: leaseItems[0].desc, price: 30, deposit: 500, duration: 3,
		category: 'digital', campus: '主校区', role: 'renter', status: 'active',
	...
	{ id: 'ml2', title: leaseItems[1].title, desc: leaseItems[1].desc, price: 8, deposit: 200, duration: 7,
		category: 'sports', campus: '东校区', role: 'lender', status: 'returned',
	...
	{ id: 'ml3', title: leaseItems[3].title, desc: leaseItems[3].desc, price: 20, deposit: 600, duration: 5,
		category: 'digital', campus: '主校区', role: 'renter', status: 'overdue',
